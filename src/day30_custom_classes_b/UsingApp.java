...
public class UsingApp {
    public static void main(String[] args) {
        ...
        System.out.println("-------------");
        new App().run();  // We created a new object ot App class and directly called the method call run().
        // Since that object has not assigned any data to instance variable "name", that is why it is printing
        // the default data/value which is null
