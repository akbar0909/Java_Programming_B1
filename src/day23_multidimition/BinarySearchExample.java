...
public class BinarySearchExample {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.binarySearch(num,20));  //In order to use this method the array MUST be SORTED.
        // That is why it is not giving the correct index.
    }
}
